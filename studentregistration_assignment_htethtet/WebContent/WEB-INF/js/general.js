...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="BUD003.html">Class Registration</a></li>';
    html = html +'<li><a href="BUD001.html?flag=1">Student Search</a></li>';
    html = html +'<li><a href="BUD002.html">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="/studentregistration_assignment_htethtet/usr001" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
